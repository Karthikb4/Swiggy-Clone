...
var _itemsListDefault = parcelHelpers.interopDefault(_itemsList);
var _cartSlice = require("../utils/cartSlice");
var _s = $RefreshSig$();
const Cart = ()=>{
    _s();
    const cartItems = (0, _reactRedux.useSelector)((store)=>store.cart.items); // for reading cart info we need to subscribe to the store
    console.log(cartItems);
    const dispatch = (0, _reactRedux.useDispatch)();
    const ClearCart = ()=>{
        console.log("Cart cleared");
        // console.log(store.getState().cart); // Before dispatching
        dispatch((0, _cartSlice.emptyCart)());
    // console.log(store.getState().cart); // After dispatching
    };
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        className: "text-center border m-4 p-4 font-bold flex flex-col  ",
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("h1", {
                children: "ITEMS ADDED INTO THE CART"
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                className: " w-6/12 border m-auto  ",
                children: cartItems.length === 0 ? /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("h1", {
                    ...
                    lineNumber: 28,
                    columnNumber: 11
                }, undefined) : /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _itemsListDefault.default), {
                    data: cartItems
                }, void 0, false, {
                    fileName: "src/components/Cart.js",
                    lineNumber: 30,
...
},{"react/jsx-dev-runtime":"iTorj","react-redux":"62sf7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru","./ItemsList":"lU2pt","../utils/cartSlice":"5RXlr"}]},["aQL8O","kFcJp"], null, "parcelRequire94c2")
